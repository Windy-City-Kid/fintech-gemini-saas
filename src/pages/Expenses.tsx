  ...
  return (
    <DashboardLayout>
      ...
      >
        ...
        <CategoryCard title="Medicare Planning" subtitle="Medicare premiums and IRMAA" icon={<Heart className="h-5 w-5" />} onStart={() => window.location.href = '/scenarios'} startLabel="Plan" />
        <CategoryCard title="Healthcare Expenses" subtitle="Medical costs and long-term care" icon={<Stethoscope className="h-5 w-5" />} onStart={() => window.location.href = '/money-flows'} startLabel="Add" />
        <CategoryCard title="Living Expenses" subtitle="Housing, utilities, daily costs" icon={<Home className="h-5 w-5" />} onStart={() => window.location.href = '/money-flows'} startLabel="Add" />
      </CategoryPageLayout>
    </DashboardLayout>
  );
}
